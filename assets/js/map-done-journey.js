...
function initMap() {
    ...
    */
    ...
    addMarker({
        ...
        <span class="offline-agent me-2"></span> 
        <span>KFC Mombasa road <small><strong></strong></small></span>
        </h6>
         <p class="">Assigned 4 Tasks</p>
         ...
         <strong>0%</strong> Of The tasks Completed</strong>
         </div> 
         <div class="progress"> 
         <div class="progress-bar progress-bar-warning" style="width: 0%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
         </div>
         </div>
         </p>
        `
